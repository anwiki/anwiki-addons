...
----------------------------------
This action runs several sets of tests to detect regressions during Anwiki development.


COMPONENT FEATURES
----------------------------------
Test cases can be run from the management panel.
